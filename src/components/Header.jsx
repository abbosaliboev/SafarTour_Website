...
function Header() {
  ...
  // ✅ Bootstrap dropdown qo‘lda faollashtirish
  useEffect(() => {
          ...
          <div className="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div className="d-inline-flex align-items-center" style={{ height: 45 }}>
              <small className="me-3 text-light">
                <i className="fa fa-plane-departure me-2" /> {t("location")}
              </small>
              <small className="me-3 text-light">
                <i className="fa fa-phone-alt me-2" /> {t("phone")}
              </small>
              <small className="text-light">
                <i className="fa fa-envelope-open me-2" /> {t("email")}
              </small>
            </div>
          </div>
        ...
        <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
          <Link to="/" className="navbar-brand p-0 d-flex align-items-center">
            <h1 className="text-primary m-0 fs-3">
              <i className="fa fa-globe-americas me-2" /> Jizzax Safar Tour
            </h1>
          </Link>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <div className="navbar-nav ms-auto py-0">
              ...
              <Link to="/Packages" className="nav-item nav-link">{t("packages")}</Link>
